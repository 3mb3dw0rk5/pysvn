...
class Test:
	...
	def test_1( self ):
		...
		self.client.remove( 'http://torment/svn/repos1/Latest/testing/bar99.txt' )

	def test_1_sub1( self, expected=None ):
		try:
			self.info( 'Expecting error %s' % expected )
			self.client.copy(	'http://torment/svn/repos1/Latest/testing/bar.txt',
				'http://torment/svn/repos1/Latest/testing/bar99.txt' )
