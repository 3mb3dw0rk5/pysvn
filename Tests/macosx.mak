all: test-01.macosx.new.log test-03.unix.new.log test-04.unix.new.log

clean:
	-rm -f test-01.macosx.new.log
	-rm -f test-03.unix.new.log
	-rm -f test-04.macosx.new.log
	-rm -rf testroot-01
	-rm -rf testroot-03
	-rm -rf testroot-04
...
test-04.unix.new.log: test-01.sh test-04.unix.known_good.log
	-rm -rf testroot-01
	./test-01.sh >test-04.unix.new.log 2>&1
