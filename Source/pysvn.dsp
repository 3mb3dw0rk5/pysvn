...
# ADD CPP /nologo /MD /W3 /GR /GX /Zi /Od /I "$(PY)\include" /I "." /I "$(RAPIDSVN)\include" /I "$(PYCXX)" /I "$(SUBVERSION)/apr/include" /I "$(SUBVERSION)/apr-util/include" /I "$(SUBVERSION)/apr-util/xml/expat/lib" /I "$(SUBVERSION)/subversion/include" /D "WIN32" /D "_WINDOWS" /D "_DEBUG" /D "noPY_WIN32_DELAYLOAD_PYTHON_DLL" /FR /YX /FD /Zm200 /c /Tp
