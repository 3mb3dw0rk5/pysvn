...
all-1.6:
	cd ..\Source & devenv pysvn-for-svn-1-6.sln /useenv /build "$(BUILD_TYPE)"  /project "pysvn"
...
clean-1.6:
	cd ..\Source & devenv pysvn-for-svn-1-6.sln /useenv /clean "$(BUILD_TYPE)"  /project "pysvn"
	cd ..\Source & del sept
